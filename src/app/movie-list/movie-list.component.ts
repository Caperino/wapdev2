...
export class MovieListComponent implements OnInit {
  ...
  constructor(public userService:UserService, private http: HttpClient, private movieService: MovieService, private starRatingConfigService: StarRatingConfigService) {
  }
